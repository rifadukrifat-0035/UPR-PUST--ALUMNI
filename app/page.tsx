...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black p-6 text-zinc-200">
      ...
      <div className="z-10 max-w-4xl text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            href="/login"
            className="flex items-center gap-2 rounded-xl border border-zinc-800 bg-zinc-900 px-8 py-4 font-semibold transition-all hover:bg-zinc-800"
          >
